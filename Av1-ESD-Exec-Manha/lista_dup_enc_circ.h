...
/**
 * @brief Remove a primeira ocorrência da sublista l2 de dentro da lista l1.
 * @param l1 Ponteiro para a lista principal.
 * @param l2 Ponteiro para a sublista a ser removida.
 * @return true se a sublista foi encontrada e removida, false caso contrário.
 */
